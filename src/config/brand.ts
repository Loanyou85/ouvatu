...
export const BRAND = {
  ...
  supportEmail: process.env.SUPPORT_EMAIL || process.env.NEXT_PUBLIC_SUPPORT_EMAIL || "support@ouvatu.app",
  legalEntity: process.env.LEGAL_ENTITY || process.env.NEXT_PUBLIC_LEGAL_ENTITY || "OUVATU (éditeur à compléter)",
} as const;
