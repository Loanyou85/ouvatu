...
const FEATURES = [
  ...
  { title: `Jusqu'à ${PLAN_LIMITS.PREMIUM.analysesPerMonth} analyses / mois`, text: `Au lieu de ${PLAN_LIMITS.FREE.analysesPerMonth} avec le plan gratuit.` },
];
  ...
  if (plan === "PREMIUM") {
    return (
      <div className="mx-auto max-w-md py-10 text-center animate-fade-up">
        ...
        <p className="mt-2 text-muted">Toutes les fonctionnalités de NOMA sont débloquées.</p>
